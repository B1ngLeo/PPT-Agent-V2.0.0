...
- [ ] A named reviewer completes the Windows screen-reader checklist with exact browser
  and assistive-technology versions (NVDA is not installed in the current environment).
- [ ] Product, security and legal approve production Provider model/region/retention/
  supplier terms and the customer disclosure in

...
All automatable P1 checks have evidence; exact Chromium 200% plus Windows screen-reader
review and the production Provider/privacy/KES-or-KMS decision are not approved and cannot
...
| Windows accessibility manual   | **pending** | Exact Chromium 200% zoom plus screen-reader flow; NVDA absent; named checklist required                                       | qa                     | —          |
| Production Provider/privacy    | **pending** | `docs/privacy-and-provider-disclosure.md`; ADR-005 and production KES/KMS approval remain open                                | product/security/legal | —          |

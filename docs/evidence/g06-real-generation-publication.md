...
The isolated real-service matrix contains 7 passed tests, zero failed, and zero
skipped. Its JUnit SHA-256 is
`1A30EDA67C0325731E3E93C81C49B759FCB8FA9786890D545DA4D687FB715C26`.
...
| Stop boundary                     | Monitor displays generation artifacts but contains no result edit, final export, download, visual mode, image, or private-template action   | passed |

## Executed verification

- `pnpm verify:integration:g06`: 7/7 real PostgreSQL/MinIO/Redis/engine cases passed;
